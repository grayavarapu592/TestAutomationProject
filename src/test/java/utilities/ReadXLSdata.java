...
public class ReadXLSdata {
	 ...
	 * IOException {
	 * 
	 * ReadXLSdata red = new ReadXLSdata(); red.getData("login");
	 * 
	 * }
	 */
	...
	public String[][] getData(Method m) throws EncryptedDocumentException, IOException {	 //used Method reflect concept 
		...
		System.out.println("No of columns:" + totalCols);
